...
The Python language reference:
    ...
    \"Compound statements consist of one or more â€˜clauses.â€™ A clause consists
    of a header and a â€˜suite.â€™ The clause headers of a particular compound
    statement are all at the same indentation level. Each clause header begins
    with a uniquely identifying keyword and ends with a colon. A suite is a
    group of statements controlled by a clause. A suite can be one or more
    semicolon-separated simple statements on the same line as the header,
    following the headerâ€™s colon, or it can be one or more indented statements
    on subsequent lines. [...]\"
