...
At the moment, ref links are not convenient to use for sections. For these you need to create a CUSTOM_ID property in the section, and then you should be able to ref link it.
