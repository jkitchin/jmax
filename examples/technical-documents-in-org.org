...
It is also possible to use a ref link to the CUSTOM_ID: section ref:sec:headline-label. You should include the word "section" in front of the ref link in any case because the link is just converted to a number in LaTeX.
