...
(defun cite-visit-key-at-point (arg)
  "find key at point and open the bibtex file at the entry corresponding to key
Note for future: a careful regexp will be needed to capture a key like j4:anythin that looks like two words to emacs, so word-at-point does not work.

arg contains the whole citation. I could split by commas, and then return the one that matches the word at point.
"
  (setq key (word-at-point))
  (let ((keys (split-string arg ","))
  (message (format "not implemented yet, but you picked %s from %s" key arg)))
...
(org-add-link-type
 "cite"
 (lambda (link-string)
   ;; the idea here is to find the boundaries of the link you
   ;; clicked on. we have to make sure that the point you clicked on
   ;; is between. I am not sure this works if the link happens to be
   ;; more than one line.
   (save-excursion
   ...
   (setq bibtex-key (buffer-substring key-beginning key-end))
...
#+RESULTS:
| cite       | cite-visit-key-at-point                                                                                                                                | (lambda (keyword desc format) (cond ((eq format (quote latex)) (cite-make-latex-links (cite-split-keys keyword)))))                                                                                                                                                                                                                                                                                                                                                                                                                        |
| wl         | org-wl-open                                                                                                                                            | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| vm-imap    | org-vm-imap-open                                                                                                                                       | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| vm         | org-vm-open                                                                                                                                            | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| rmail      | org-rmail-open                                                                                                                                         | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| mhe        | org-mhe-open                                                                                                                                           | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| mew        | org-mew-open                                                                                                                                           | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| irc        | org-irc-visit                                                                                                                                          | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| info       | org-info-open                                                                                                                                          | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| gnus       | org-gnus-open                                                                                                                                          | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| docview    | org-docview-open                                                                                                                                       | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bibtex     | org-bibtex-open                                                                                                                                        | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bbdb       | org-bbdb-open                                                                                                                                          | org-bbdb-export                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ref        | (lambda (arg) nil)                                                                                                                                     | (lambda (keyword desc format) (cond ((eq format (quote latex)) (format \ref{%s} keyword))))                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| figure     | (lambda (arg) (find-file arg))                                                                                                                         | (lambda (keyword desc format) (cond ((eq format (quote html)) (format \n<table class='image'>\n<tr><td><img src='%s.png' alt='%s'/></td></tr>\n<tr><td class='caption'>%s</td></tr>\n</table>\n keyword desc desc)) ((eq format (quote latex)) (if desc (format \n\begin{figure}[H]\n\includegraphics[width=0.7\textwidth]{%s}\n\caption{%s}\n\end{figure}\n (replace-in-string keyword .svg .pdf) desc) (format \n\begin{figure}[H]\n\includegraphics[width=0.7\textwidth]{%s}\n\end{figure}\n (replace-in-string keyword .svg .pdf)))))) |
| index      | (lambda (arg) nil)                                                                                                                                     | (lambda (keyword desc format) (cond ((eq format (quote html)) (format )) ((eq format (quote latex)) (format \index{%s} keyword))))                                                                                                                                                                                                                                                                                                                                                                                                         |
| func       | (lambda (arg) (shell-command (format pydoc %s arg) nil))                                                                                               | (lambda (path desc format) (cond ((eq format (quote html)) (format %s path)) ((eq format (quote latex)) (format \texttt{%s} path))))                                                                                                                                                                                                                                                                                                                                                                                                       |
| mod        | (lambda (arg) (shell-command (format pydoc %s arg) nil))                                                                                               | (lambda (path desc format) (cond ((eq format (quote html)) (format %s path)) ((eq format (quote latex)) (format \texttt{%s} path))))                                                                                                                                                                                                                                                                                                                                                                                                       |
| incar      | (lambda (keyword) (shell-command (format firefox http://cms.mpi.univie.ac.at/wiki/index.php/%s keyword) nil))                                          | (lambda (keyword link format) (cond ((eq format (quote html)) (format <a href=http://cms.mpi.univie.ac.at/wiki/index.php/%s>%s</a> keyword keyword)) ((eq format (quote latex)) (format \href{http://cms.mpi.univie.ac.at/wiki/index.php/%s}{%s} keyword keyword))))                                                                                                                                                                                                                                                                       |
| color      | (lambda (path) (message (concat color  (progn (add-text-properties 0 (length path) (list (quote face) (` ((t (:foreground (, path)))))) path) path)))) | (lambda (path desc format) (cond ((eq format (quote html)) (format <span style="color:%s;">%s</span> path desc)) ((eq format (quote latex)) (format {\color{%s}%s} path desc))))                                                                                                                                                                                                                                                                                                                                                           |
| ashell     | org-ashell-open                                                                                                                                        | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| msx        | org-msx-open                                                                                                                                           | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| id         | org-id-open                                                                                                                                            | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| file+emacs | org-open-file-with-emacs                                                                                                                               | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| file+sys   | org-open-file-with-system                                                                                                                              | nil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |

bibtex:../export.bib::citeulike:10862950
