...
(easy-menu-define my-menu kitchingroup-mode-map "My own menu"
  '("KitchinGroup"
    ...
    ("bibtex"
     ...
     ["clean entry" org-ref-clean-bibtex-entry t]
     ["Open entry pdf" org-ref-open-bibtex-pdf t]
     ["Open entry url" org-ref-open-in-browser t]
     ["Open entry in WOS" jmax-bibtex-wos t]
     ["Find related entries" jmax-bibtex-related t]
     ["Find citing articles" jmax-bibtex-citing t]
     ["Open entry in Google Scholar" jmax-bibtex-google-scholar t]
     ["Open entry in Crossref" jmax-bibtex-crossref t]
     ["Open entry in Pubmed" jmax-bibtex-pubmed t]
